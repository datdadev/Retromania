      ...
      <main className="min-h-screen relative">
        ...
        <div className='my-container'>
          <section className='relative'>
            ...
            <IoCaretDownSharp className='absolute bottom-1.5 right-1/2' size={36} />
          </section>
          ...
          <section className='relative py-16'>
            <div className='w-full flex flex-col justify-between'>
              <div className='flex'>
                <div className='basis-1/2'>
                  <h1 className={`${ps2p.variable} font-ps2p text-2xl Lg:text-4xl text-center`}>Available</h1>
                </div>
                <div className='basis-1/2'>
                  <h1 className={`${ps2p.variable} font-ps2p text-2xl Lg:text-4xl text-center`}>Features</h1>
                </div>
              </div>
              <div className='py-5 flex flex-col mx-auto'>
                <h1 className={`${ps2p.variable} font-ps2p mb-5 text-2xl Lg:text-4xl text-center`}>Compability</h1>
                <div className=' mx-auto flex gap-5'>
                  <FaSafari size={36} />
                  <SiFirefoxbrowser size={36} />
                  <SiGooglechrome size={36} />
                  <SiOpera size={36} />
                  <SiBrave size={36} />
                </div>
              </div>
