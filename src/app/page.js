...
import { CgArrowsExpandUpLeft, CgArrowsExpandUpRight, CgArrowsExpandDownLeft, CgArrowsExpandDownRight, CgCornerUpLeft } from "react-icons/cg"
...
export default function Home() {
  ...
  const [screenSizeWarning, setscreenSizeWarning] = useState(false);
  ...
  useEffect(() => {
    setscreenSizeWarning(isMobile);
    !isMobile && setPlayerVisibility(true);
  ...
  return (
    ...
    {screenSizeWarning ?
      <div>
        <div>
          {/* Upleft arrow */}
          <div className="absolute top-2 left-2 hover:top-4 hover:left-4 hover:scale-150 duration-100">
            <CgArrowsExpandUpLeft size={42.5} strokeWidth={0.5} />
          </div>

          {/* Upright arrow */}
          <div className="absolute top-2 right-2 hover:top-4 hover:right-4 hover:scale-150 duration-100">
            <CgArrowsExpandUpRight size={42.5} strokeWidth={0.5} />
          </div>

          {/* Downleft arrow */}
          <div className="absolute bottom-2 left-2 hover:bottom-4 hover:left-4 hover:scale-150 duration-100">
            <CgArrowsExpandDownLeft size={42.5} strokeWidth={0.5} />
          </div>

          {/* Downright arrow */}
          <div className="absolute bottom-2 right-2 hover:bottom-4 hover:right-4 hover:scale-150 duration-100">
            <CgArrowsExpandDownRight size={42.5} strokeWidth={0.5} />
          </div>
        </div>
        <div className="h-screen flex items-center justify-center gap-6">
          <div className={`${ps2p.variable} font-ps2p flex flex-col items-center justify-center gap-3 text-lg`}>
            <div className='flex flex-col items-center justify-center gap-1.5'>
              <h1>Best viewed on</h1>
              <h1><span className='text-3xl font-bold'>larger</span> screens</h1>
            </div>
            <div className='w-24 h-1 bg-white/50' />
            <button className='underline transform hover:rotate-[5deg] duration-100'
              onClick={() => {
                setscreenSizeWarning(false);
