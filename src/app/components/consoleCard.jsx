    ...
    return (
        <a href={`/${name.toLowerCase()}`} className='px-4 py-2 group cursor-pointer border-4 border-black hover:border-white flex flex-col items-center'>
            <div className='relative w-[130px] h-[100px] xl:w-[220px] xl:h-[170px]'>
                <Image className='absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-100 group-hover:opacity-0 duration-150' height={100} src={image} />
                <Image className='absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 duration-150' height={100} src={gif} />
            </div>
